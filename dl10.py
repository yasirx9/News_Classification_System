...
history = model.fit(X_train_tfidf, y_train_encoded, epochs=10, batch_size=32, validation_data=(X_test_tfidf, y_test_encoded))
...
ax1.set_title('Epoch Accuracy Diagram for 10 Epochs')
ax1.legend()
...
ax2.set_ylabel('Loss')
ax2.set_title('Epoch Loss Diagram for 10 Epochs')
ax2.legend()
